...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auth', '0015_remove_user_confirm_password'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modules', models.ManyToManyField(related_name='modules', to='user.customusermodule')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('modules', models.ManyToManyField(related_name='permissions', to='user.customusermodule')),
                ('roles', models.ManyToManyField(max_length=255, to='user.customuserrole')),
            ],
        ),
    ]
